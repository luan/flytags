...
const (
	Version     = "0.1.0"
	Name        = "flytags"
	URL         = "https://github.com/luan/flytags"
...
func init() {
	...
	flags.Usage = func() {
		fmt.Fprintf(os.Stderr, "flytags version %s\n\n", Version)
...
func main() {
	...
	if len(outputFile) == 0 || outputFile == "-" {
		// For compatibility with older flytags versions, also write to stdout
